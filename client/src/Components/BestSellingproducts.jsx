...
const BestSellingProducts = () => {
  ...
  return (
    <div>
      <h1 className='ml-6 text-2xl mt-4 font-bold'>Best Selling Products</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 cursor-pointer lg:grid-cols-5 gap-6 p-6">
        {filteredProducts.slice(0, 5).map((product) => (
          ...
          >
            {/* Product Image */}
            <div className="w-full h-48 bg-gray-100 hover:scale-105 flex items-center justify-center">
              <img
                src={product.image}
                alt={product.name}
